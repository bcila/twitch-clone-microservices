...
const (
	...
	StreamService_SaveStreamToS3_FullMethodName = "/stream.StreamService/SaveStreamToS3"
)
...
type StreamServiceClient interface {
	...
	SaveStreamToS3(ctx context.Context, in *SaveStreamToS3Request, opts ...grpc.CallOption) (*SaveStreamToS3Response, error)
}
...
func (c *streamServiceClient) SaveStreamToS3(ctx context.Context, in *SaveStreamToS3Request, opts ...grpc.CallOption) (*SaveStreamToS3Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SaveStreamToS3Response)
	err := c.cc.Invoke(ctx, StreamService_SaveStreamToS3_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StreamServiceServer interface {
	...
	SaveStreamToS3(context.Context, *SaveStreamToS3Request) (*SaveStreamToS3Response, error)
...
func (UnimplementedStreamServiceServer) SaveStreamToS3(context.Context, *SaveStreamToS3Request) (*SaveStreamToS3Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SaveStreamToS3 not implemented")
}
...
func _StreamService_SaveStreamToS3_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SaveStreamToS3Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamServiceServer).SaveStreamToS3(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamService_SaveStreamToS3_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamServiceServer).SaveStreamToS3(ctx, req.(*SaveStreamToS3Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StreamService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SaveStreamToS3",
			Handler:    _StreamService_SaveStreamToS3_Handler,
		},
	},
